...
@Getter
@AllArgsConstructor
@Schema(description = "Данные единицы оборудования технического устройства тепловой сети")
public class ResponseEquipmentUnitDeviceDto {
    ...
    @Schema(description = "Наименование участка тепловой сети")
    private String heatSupplySite;
    @Schema(description = "Наименование технического устройства")
