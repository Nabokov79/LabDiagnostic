...
public class UpdateJournalDiagnosticsHeatSupplyDto {
    ...
    @NotNull(message = "equipment library id should not be null")
    @Positive(message = "equipment library id can only be positive")
    ...
    public String toString() {
        return "UpdateJournalDiagnosticsHeatSupplyDto{" +
                "id=" + id +
                ", date=" + date +
                ", heatSupplyAreaId=" + heatSupplyAreaId +
                ", addressId=" + addressId +
                ", equipmentLibraryId=" + equipmentId +
                ", elementLibraryId=" + elementId +
