...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "Данные для добавления записи в журнал диагностики оборудования котельной, цтп")
public class NewJournalDiagnoticsEquipmentDto {
    ...
    public String toString() {
        return "NewJournalDiagnoticsEquipmentDto{" +
                "date=" + date +
